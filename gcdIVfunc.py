...
class WinGCDIV:
    def __init__(self, root,title,fname,const,save):
        ...
        dd=gcdIV(self.fname,[float(self.sMin1.get()),float(self.sMax1.get()),float(self.sMin2.get()),float(self.sMax2.get())])
        ...
        self.b2=Button(self.root,text='Update',command= self.UpdateGCDIV)
